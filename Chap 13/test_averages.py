...
class TestAvg:
    def __init__(self):
        ...
        #Create and pack widgets for average
        self.result_label = tkinter.Label(self.avg_frame,
                                         text='Average:')
        self.avg = tkinter.StringVar() #to update avg label
        self.avg_label = tkinter.Label(self.avg_frame,
                                       textvariable = self.avg)
        self.result_label.pack(side='left')
        self.avg_label.pack(side='left')

        #Create and pack the buttons widgets
        self.calc_btn = tkinter.Button(self.btn_frame, text='Average',
                                       command=self.calc_avg)
        self.quit_btn = tkinter.Button(self.btn_frame, text='Quit',
